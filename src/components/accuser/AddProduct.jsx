...
const AddProduct = ({setOpenAdd}) => {
    ...
    const validateImageProduct = async (e) => {
        ...
        if(fileProduct.size >= 5048576) {
            return alert("Max Size for Image is 5MB");
        } else {
    ...
    const uploadImageProduct = async () => {
        ...
        dataProduct.append("upload_preset", "hakunia");
        try {

            setUploadingImageProduct(true);
            let res = await fetch("https://api.cloudinary.com/v1_1/hafidkrntn/image/upload", {
    ...
    <div className='passwords'>
      <form onSubmit={handlerAddProduct}>
        ...
        <div className="form-group form-image product">
            <img src={previewImageProduct || "https://res.cloudinary.com/hafidkrntn/image/upload/v1655630421/universa_ocbphf.png"} alt="" />
