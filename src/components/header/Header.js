  ...
  return (
    <div className='header-row'>
        <div className="header-top">
            <span><FontAwesomeIcon icon={faPhone}/>+62 851-5627-8510</span>
            <span><FontAwesomeIcon icon={faEnvelope}/>hafidkrntn@gmail.com</span>
        </div>
        <div className="header-menu">
            <div className="header-logo">
                <Link to="/"><h2 className="header-logo-title">Hakunia</h2></Link>
            </div>
